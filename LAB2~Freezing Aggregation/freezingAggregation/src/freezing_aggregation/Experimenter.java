...
public class Experimenter extends Observer {
	...
	public void step(SimState state) {
		super.step(state);
		if(step %this.state.dataSamplingInterval == 0) { // remember "%" is the remainder operator, 
			//so this logical statement translates as "is this step a multiple of the interval we set?"
